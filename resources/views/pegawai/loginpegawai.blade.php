		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form action="{{ route('cekloginpegawai') }}" class="signin-form" method="POST">
								@csrf
		          ...
		          <p class="text-center">Not a member? <a data-toggle="tab" href="{{ url('registerpegawai') }}">Register</a></p>
		          <p class="text-center">Not a user? <a data-toggle="tab" href="{{ url('adminlogin') }}">Admin</a></p>
		        </div>
		      </div>
				</div>
			</div>
